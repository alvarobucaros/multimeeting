...
app.controller('mainController',['$scope','$http', function($scope,$http){
    ...
    $scope.tit04='Con este sistema se puede llevar múltiples reuniones tales como: comités, juntas, contratos o cualquier tipo de reunión que amerite tener un seguimiento con su respectiva acta o minuta de reunión.';
    $scope.tit05='Incluya la lista de asistentes a la reuniones, selecione el salón donde esta se ha de llevar, haga la preparación de los temas a tratar junto con los pendientes de reuniones anteriores, adicione los asistente o invitados especiales, una vez configudao esto, envie la invitación junto con el temario vía correo electrónico y/o mensaje de texto al celular usando la opicón del menú';
    $scope.tit06='Durante el desarrollo de la reunión haga las anotaciones pertinentes a cada tema tratado, a medida que se  hace este trabajo se va creando el acta o minuta, así, al final se puede revisar y aprobarla, se imprime se firma por los asistentes y se carga por medio de la opción de administración de contenidos junto con los documentos soportes de la reunión tales como: contratos, cotizaciones, cuadros u otro documento de la reunión, de tal manera que puedan ser consultados por todos';

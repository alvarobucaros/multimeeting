        ...
        <div class="col-md-8 col-md-offset-1">
            ...
            <form class="form-horizontal alert alert-mm color-palette-set" name="formato" id="idForm"
                ...
                <div class="form-group">
                   ...
                   <label>
                      <input type="radio" name ="propietarioActivo" ng-model="registro.propietarioActivo" value="I" >{{form_todassi}}
                   </label>
                   <label>
                      <input type="radio" name ="propietarioActivo" ng-model="registro.propietarioActivo" value="A" >{{form_todasno}}
                   </label>
                    </div>
                </div> 

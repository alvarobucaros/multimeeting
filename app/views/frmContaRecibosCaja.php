    <div class="container "  ng-controller="mainController">
       ...
       <div class="col-md-8 col-md-offset-1">
            ...
            <form class="form-horizontal alert alert-mm color-palette-set" name="formato" id="idForm"
                ...
                <div class="form-group">
                   <label class="milabel col-md-4" for="fechaAbono">{{form_fechaAbono}}</label>
                   <div class="col-md-6">
                 ...
                 <div class="form-group">
                    <label class="milabel col-md-4" for="comprobante">{{comprobanteRC}}</label>
                   <div class="col-md-6">
                ...
                <div class="form-group">
                     <label class="milabel col-md-4" for="msg">{{titSaldo}}</label>
                ...
                <div class="form-group">
                    <label class="milabel col-md-4" for="vlrPago">{{titvlrPago}}</label>
                   <div class="col-md-6">
                ...
                <div class="form-group">
                    <label class="milabel col-md-4" for="formaPago">{{titformaPago}}</label>
               ...
               <div class="form-group">
                   <label class="milabel col-md-4" for="referencia">{{titreferencia}}</label>
                   <div class="col-md-6">
                       <input type="text" class="form-control mitexto" id="referencia" name="referencia" width="100"
